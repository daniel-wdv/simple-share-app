...
<!-- ABOUT THE PROJECT -->
## About The Project
This is a simple share app with register/login system and with user verification.
...
Open phpmyadmin and import the database that is inside the resources folder.
After this change the config.php file to match your database information.

Just run an apache or nginx server and call "localhost/shareposts" on your browser.
